package crazyFlowControlAndArray.No4_5;

/**
 * in java language the index of array is 
 * begin with 0.so you can use for loop
 * to get the value of array.like this
 * (int i=0;i<array.length;i++)
 *
 * @author yong 2013-6-16 下午3:47:17
 *
 */
